        ...
        <div class="col-10 mt-3 ">
            <div class="row justify-content-end">
                <div class="col-4 d-flex justify-content-end ">
                    {{-- <form action="/download/simpanan" method="post" class=" d-inline justify-content-end">
                        @csrf
                    ...
                    <a href="/print-simpanan" target="_Blank" class="mt-2 ms-3">
            ...
            <table class="table">
                <tr class="">
                    ...
                    <th class=" col-3">Simpanan Wajib</th>
                ...
                @foreach ($user as $user)
                    <tr>
                        ...
                        <td class="text-end"><a href="/anggota/{{ Crypt::encryptString($user->id) }}"
                                class="btn text-primary">Detail</a></td>
                    </tr>
                @endforeach
                <tr class="">
                    <th>Total</th>
